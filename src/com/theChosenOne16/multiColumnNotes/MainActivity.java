package com.theChosenOne16.multiColumnNotes;
...
public class MainActivity extends Activity{
	...
	String texts[] = new String[]{
			"Mobile Programming" , "Android Kitkat", "Microsoft and Apple" , "Android Programming is Fun",
			"Technology to the Rescue", "Android Fragmentation",
			"Multi-Column Notes", 
			};
